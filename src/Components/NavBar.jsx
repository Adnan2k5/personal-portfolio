...
export const NavBar = () => {
  ...
  return (
    <div className={`nav-container z-50 p-5 m-auto transition-all duration-100 w-full fixed ${scrolled ? 'bg-black/50 backdrop-blur-md' : 'bg-transparent'} flex justify-between items-center`}>
      <div className="logo text-xl text-center md:text-2xl">Adnan Ashraf</div>
      <div className="pages flex-1 ml-10 md:ml-20">
