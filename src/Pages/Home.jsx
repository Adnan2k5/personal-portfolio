...
//     <div>
//       <Layout>
//         <div id="home" className="home-box w-[100vw] h-[80vh] mt-[10vh] z-10 flex absolute">
  ...
  return (
    <div>
      <Layout>
        <div
          id="home"
          className="home-box w-[100vw] h-[80vh] mt-[10vh] z-10 flex flex-col lg:flex-row absolute"
        >
          ...
          <div className="vector-side relative -ml-0 lg:-ml-[12rem] -z-10 flex justify-center lg:justify-start h-[50vh] lg:h-[80vh] mt-5 lg:mt-0">
            <img
              className="w-[60%] lg:w-full h-full rounded-full object-cover"
              src={vector}
              alt="vector"
            />
          </div>
